# ============================================================
#  시율이 그림 그래프 - 그림 업데이트 스크립트
#  "4살에 만든 작품" 폴더의 사진을 읽어서 artworks-data.js 를
